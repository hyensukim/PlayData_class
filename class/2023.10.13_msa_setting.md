...
![로깅필터3](https://file+.vscode-resource.vscode-cdn.net/c%3A/PlayData/phase02/class/)


매개변수를 제공하는 경우 아래와 같이 구분하여 나열해준다.

![로깅필터4](https://file+.vscode-resource.vscode-cdn.net/c%3A/PlayData/phase02/class/)
