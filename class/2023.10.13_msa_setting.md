...
![img](https://file.notion.so/f/f/93bcb278-6084-4807-9932-df65b17cb21a/96642a2a-25f2-4c8e-a3ec-4613f9a08341/Untitled.png?id=9311d5ae-61de-459e-aaa8-4f125f559995&table=block&spaceId=93bcb278-6084-4807-9932-df65b17cb21a&expirationTimestamp=1697248800000&signature=BvfqkH_9pcmd2HOSFBpg4w1qtHtzcrg9qPVzBSCGAXo&downloadName=Untitled.png)
...
- uri : 게이트웨이 서버가 아래에 등록할 predicates의 패턴을 감지했을 때 어떤 서버로 포워딩할 지
- predicates : 어떤 조건을 만족할 때 연동된 uri로 보내줄건지 조건 작성(조건문).
...
MicroService의 핵심은 Proxy 즉, 단일 서버로 보이도록 해주는 것이 중요하다.
...
다음 설정파일에서 넘겨주는 인자값을 받을 수 있도록 Config 이너 클래스에 멤버 필드들을 선언한다. 그리고 lombok의 @Getter를 추가해준다.

![img](https://nohitnorun.notion.site/image/https%3A%2F%2Fprod-files-secure.s3.us-west-2.amazonaws.com%2F93bcb278-6084-4807-9932-df65b17cb21a%2Fd3c77e7e-7fea-4484-a2aa-41309c90dcce%2FUntitled.png?table=block&id=7e09cf6e-aa8c-45f9-bb5b-65aa9aa1f31b&spaceId=93bcb278-6084-4807-9932-df65b17cb21a&width=740&userId=&cache=v2)
